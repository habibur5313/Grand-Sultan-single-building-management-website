...
const Dashboard = () => {
  ...
  return (
    <div className="container mx-auto">
      ...
      {role === "admin" && (
        <>
          <h1 onClick={() => setMenu(true)} className="lg:hidden">
            Home
          </h1>
          <div className="lg:hidden ">
            <div
              className={` ${
                menu ? "block absolute top-0 left-0" : "hidden"
      ...
      {role === "member" && (
        <div className="flex gap-10">
          <div className="w-72 py-10 px-4 hidden lg:block bg-purple-700 text-white min-h-screen">
